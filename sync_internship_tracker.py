#!/usr/bin/env python3
"""Append newly discovered internship opportunities to Internship Tracker."""
...
def main() -> None:
    ...
    parser.add_argument("--tab", default="Internship Tracker")
    ...
    print(f"Added {count} internship opportunity row(s).")
